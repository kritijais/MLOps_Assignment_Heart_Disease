import pandas as pd
import pytest
from src.features.data_pipeline import load_and_clean_data, create_preprocessor, NUMERICAL_FEATURES, CATEGORICAL_FEATURES, IMPUTE_ENCODE_FEATURES

def test_load_and_clean_data_shape():
    df = load_and_clean_data()
    # Expect at least 1 row and all required columns
    expected_columns = NUMERICAL_FEATURES + CATEGORICAL_FEATURES + IMPUTE_ENCODE_FEATURES + ['heart_disease']
